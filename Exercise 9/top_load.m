...
function top_load(nelx,nely,volfrac,penal,rmin, Fx, Fy);
% INITIALIZE
...
%%%%%%%%%% FE-ANALYSIS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [U]=FE(nelx,nely,x,penal,Fx,Fy)
[KE] = lk; 
...
F(2*node-1,1) = Fx; % x load
F(2*node,1) = Fy; % y load
